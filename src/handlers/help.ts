...
const HELP =
  "Open /start to manage verification, moderation, and audit records.\n\n" +
  "Group admins can use the dashboard. New members can verify with the button in the group welcome message.";
